...
class LoadingScreen:
    def __init__(self, surface, font, total_steps, background_color=(0, 0, 0), text_color=(255, 255, 255)):
    ...
    def draw(self):
        ...
        pygame.draw.rect(self.surface, (200, 200, 200), (bar_x, bar_y, bar_width, bar_height))
        
        progress_width = int(bar_width * (self.progress / 100))
        pygame.draw.rect(self.surface, self.text_color, (bar_x, bar_y, progress_width, bar_height))
